              ...
              {filtered.map((m) => (
                <div key={m.id} className="relative group">
                  ...
                  <button
                    ...
                    className="absolute top-2.5 right-12 opacity-0 group-hover:opacity-100 transition-opacity bg-surface-3 border border-border-default rounded p-1 text-text-tertiary hover:text-text-primary z-10"
