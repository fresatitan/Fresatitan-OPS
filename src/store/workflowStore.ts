...
const SEED_MAQUINAS: Maquina[] = [
  ...
  { id: 'm17', codigo: 'REF-CREATE', etiqueta: 'TI 1', nombre: 'Sinterizadora ZONELAB CREATE',   tipo: 'sinterizadora', subtipo: 'titanio', numero_serie: '02A0426002', descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  // Impresoras 3D
