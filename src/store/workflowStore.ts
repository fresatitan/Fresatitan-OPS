...
const SEED_MAQUINAS: Maquina[] = [
  // Fresadoras SECO
  { id: 'm1',  codigo: 'REF-030', etiqueta: 'Zr 1',   nombre: 'Fresadora UP3D ZR1',              tipo: 'fresadora',    subtipo: 'seco',   numero_serie: '20222065', descripcion: null, ubicacion: 'Zona CAD-CAM', estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm2',  codigo: 'REF-057', etiqueta: 'Zr 2',   nombre: 'Fresadora UP P53 ZR2',            tipo: 'fresadora',    subtipo: 'seco',   numero_serie: '20244451', descripcion: null, ubicacion: 'Zona CAD-CAM', estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm13', codigo: 'REF-064', etiqueta: 'Zr 3',   nombre: 'Fresadora UP P53 DC ZR3',         tipo: 'fresadora',    subtipo: 'seco',   numero_serie: '20244497', descripcion: null, ubicacion: 'Zona CAD-CAM', estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  // Fresadoras HÚMEDO
  { id: 'm3',  codigo: 'REF-062', etiqueta: 'Ds 2',   nombre: 'Fresadora UP3D P42 DS2',          tipo: 'fresadora',    subtipo: 'humedo', numero_serie: '20244135', descripcion: null, ubicacion: 'Zona CAD-CAM', estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm6',  codigo: 'REF-042', etiqueta: 'Ds 1',   nombre: 'Fresadora BIO1000 DS1',           tipo: 'fresadora',    subtipo: 'humedo', numero_serie: 'DF100-1020', descripcion: null, ubicacion: 'Zona CNC',     estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  // Fresadoras METAL
  { id: 'm4',  codigo: 'REF-039', etiqueta: 'F 1',    nombre: 'Fresadora FANUC1',                tipo: 'fresadora',    subtipo: 'metal',  numero_serie: 'P188ZG886', descripcion: null, ubicacion: 'Zona CNC',    estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm5',  codigo: 'REF-040', etiqueta: 'F 2',    nombre: 'Fresadora FANUC2',                tipo: 'fresadora',    subtipo: 'metal',  numero_serie: 'P229AG695', descripcion: null, ubicacion: 'Zona CNC',    estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm14', codigo: 'REF-066', etiqueta: 'F 3',    nombre: 'Fresadora FANUC3',                tipo: 'fresadora',    subtipo: 'metal',  numero_serie: 'P246AG322', descripcion: null, ubicacion: 'Zona CNC',    estado_actual: 'parada',   requiere_preparacion: false, requiere_lanzamiento: false, activa: true,  created_at: nowIso, updated_at: nowIso },
  { id: 'm7',  codigo: 'REF-041', etiqueta: null,     nombre: 'Fresadora CM Lilian',             tipo: 'fresadora',    subtipo: 'metal',  numero_serie: '12654',    descripcion: 'Retirada del servicio', ubicacion: 'Zona CNC', estado_actual: 'inactiva', requiere_preparacion: false, requiere_lanzamiento: false, activa: false, created_at: nowIso, updated_at: nowIso },
  // Sinterizadoras (únicas con lanzamiento)
  { id: 'm8',  codigo: 'REF-045', etiqueta: 'SINT 1', nombre: 'Sinterizadora TRUMPF MULTILASER', tipo: 'sinterizadora', subtipo: 'cr_co', numero_serie: 'S0711Q0182', descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm9',  codigo: 'REF-046', etiqueta: 'SINT 2', nombre: 'Sinterizadora TRUMPF 3D LASER',   tipo: 'sinterizadora', subtipo: 'cr_co', numero_serie: 'S0711Q069',  descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm10', codigo: 'REF-047', etiqueta: 'SINT 3', nombre: 'Sinterizadora TRUMPF',            tipo: 'sinterizadora', subtipo: 'cr_co', numero_serie: 'S0711Q0022', descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm11', codigo: 'REF-048', etiqueta: 'SINT 4', nombre: 'Sinterizadora SISMA 2 MYSINT',    tipo: 'sinterizadora', subtipo: 'cr_co', numero_serie: 'LS0005866',  descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm12', codigo: 'REF-049', etiqueta: 'SINT 5', nombre: 'Sinterizadora SISMA 1 MYSINT',    tipo: 'sinterizadora', subtipo: 'cr_co', numero_serie: 'LS0008790',  descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm17', codigo: 'REF-TITANIO', etiqueta: 'TI 1', nombre: 'Sinterizadora ZONELAB CREATE',   tipo: 'sinterizadora', subtipo: 'titanio', numero_serie: '02A0426002', descripcion: null, ubicacion: 'Zona Sinter.', estado_actual: 'parada', requiere_preparacion: true, requiere_lanzamiento: true, activa: true, created_at: nowIso, updated_at: nowIso },
  // Impresoras 3D
  { id: 'm15', codigo: 'REF-063', etiqueta: 'Imp 1',  nombre: 'Impresora PROZEN SONIC XL 4K',    tipo: 'impresora_3d', subtipo: null, numero_serie: 'LCSXFT11003', descripcion: null, ubicacion: 'Zona Impresión 3D', estado_actual: 'parada', requiere_preparacion: false, requiere_lanzamiento: false, activa: true, created_at: nowIso, updated_at: nowIso },
  { id: 'm16', codigo: 'REF-067', etiqueta: 'Imp 2',  nombre: 'Impresora MIICRAFT',              tipo: 'impresora_3d', subtipo: null, numero_serie: 'LM300G003',   descripcion: null, ubicacion: 'Zona Impresión 3D', estado_actual: 'parada', requiere_preparacion: false, requiere_lanzamiento: false, activa: true, created_at: nowIso, updated_at: nowIso },
]
...
interface WorkflowState {
  ...
  addMaquina: (data: Pick<Maquina, 'codigo' | 'nombre' | 'etiqueta' | 'tipo' | 'subtipo' | 'requiere_preparacion' | 'requiere_lanzamiento' | 'descripcion' | 'ubicacion'>) => Promise<void>
  updateMaquina: (id: string, data: Partial<Pick<Maquina, 'codigo' | 'nombre' | 'etiqueta' | 'tipo' | 'subtipo' | 'requiere_preparacion' | 'requiere_lanzamiento' | 'descripcion' | 'ubicacion' | 'activa'>>) => Promise<void>
...
export const useWorkflowStore = create<WorkflowState>((set, get) => ({
  ...
  addMaquina: async (data) => {
    const payload = {
      ...
      subtipo: data.tipo === 'impresora_3d' ? null : data.subtipo ?? null,
      numero_serie: null,
